...
import { FSAppleMailConfigRepo, IAppleMailConfigRepo } from "../knowledge/apple_mail/repo.js";
import { FSAppleCalendarConfigRepo, IAppleCalendarConfigRepo } from "../knowledge/apple_calendar/repo.js";
...
container.register({
    ...
    appleMailConfigRepo: asClass<IAppleMailConfigRepo>(FSAppleMailConfigRepo).singleton(),
    appleCalendarConfigRepo: asClass<IAppleCalendarConfigRepo>(FSAppleCalendarConfigRepo).singleton(),
